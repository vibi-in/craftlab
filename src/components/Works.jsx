    ...
    <div className=' flex flex-col lg:ml-[130px] lg:mr-[130px] ml-[24px] mr-[24px] '>
      ...
      <div className='flex flex-wrap justify-between'>
        <div class="relative overflow-hidden group">
          ...
          <p class='text-[#B3B3B3] text-start font-satoshi text-[16px] lg:text-[18px] font-[300] mb-[50px] lg:mb-[0px]'>Welcome to Company, where creativity knows <br />no bounds and design is our passion.</p>
        </div>
        ...
        <div class="relative overflow-hidden group">
          ...
          <p className='text-[#B3B3B3] text-start font-satoshi text-[16px] lg:text-[18px] font-[300] mb-[50px] lg:mb-[0px]'>Welcome to Company, where creativity knows <br />no bounds and design is our passion.</p>
        </div>
